	...
	bool SNMPResponse::build(){
	    ...
	    response->addValueToList(new IntegerType((int)version));
	    response->addValueToList(new OctetType((char *)communityString));
	    ComplexType* PDUObj;
	    PDUObj = new ComplexType(responseType);
